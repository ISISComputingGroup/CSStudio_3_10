...
public class CreateChannelResponse extends AbstractCAJResponseHandler {
    ...
    private static final org.apache.logging.log4j.Logger LOG = IsisLog.getLogger(CreateChannelResponse.class);
    ...
    protected void internalHandleResponse(
        ...
        if (channel != null) {
            ...
            LOG.info("Ticket2162: " + channel.getName() + " - CreateChannel connect complete");
        }
