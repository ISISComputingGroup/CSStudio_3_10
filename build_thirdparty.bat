...
REM build it
call mvn --settings=%CD%\mvn_user_settings.xml -Dmaven.repo.local=%MAVENDIR% -Dcsstudio.local.repo=%LOCINSTALLDIR% -f cs-studio-thirdparty-3.3.x\pom.xml clean verify
